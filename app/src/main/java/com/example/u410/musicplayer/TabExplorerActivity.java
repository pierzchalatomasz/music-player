...
public class TabExplorerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_explorer);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_tab_explorer, menu);
        return true;
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        private final int EXPLORER_TAB = 0;
        private final int NEW_PLAYLIST_TAB = 1;
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case EXPLORER_TAB:
                    return getString(R.string.explorer_tab);
                case NEW_PLAYLIST_TAB:
                    return getString(R.string.new_playlist_tab);
            }
            return null;
        }
    }
